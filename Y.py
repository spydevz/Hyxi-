...
print(Colorate.Horizontal(Colors.white_to_white, Center.XCenter(info)))
print(Colorate.Horizontal(Colors.red_to_white, Center.XCenter(commands)))
...
def main():
    while True:
        cmd = input("Hyper•C2 >> ").strip()

        if cmd == "/methods":
            print(Colorate.Horizontal(Colors.red_to_white, commands))
